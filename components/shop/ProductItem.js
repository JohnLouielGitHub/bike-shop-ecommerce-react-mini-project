...
const ProductItem = ({data}) => {
  ...
  const productImage = "https://www.sefiles.net/merchant/1718/images/site/Trek_Emonda_ALR_15-slimC.jpg"
        ...
        return !isVisible ? null : (
          <div className="modal cursor-auto">
            ...
            <button className="w-full relative text-center h-64 bg-gray-300 bg-center bg-cover shadow-md object-center  border-2 border-gray-900 border-solid border-opacity-10">
                <Image alt="CarouselImage1" src={productImage}  layout="fill" objectFit="cover"/>
            </button>
              ...
              <div className="modal-body">
                ...
                <span>
                <button className="px-2 py-1 mr-3 text-xs font-semibold text-white uppercase transition-colors duration-200 transform bg-gray-800 rounded hover:bg-gray-700 dark:hover:bg-gray-600 focus:bg-gray-700 dark:focus:bg-gray-600 focus:outline-none"
                onClick={() => onAddToCart(data)}>Add to cart</button>
                <button  className="px-2 py-1 mr-3 text-xs font-semibold text-white uppercase transition-colors duration-200 transform bg-red-800 rounded hover:bg-red-700 dark:hover:bg-red-600 focus:bg-red-700 dark:focus:bg-red-600 focus:outline-none" onClick={onClose}>x</button>
                </span>
    ...
    <div className="flex flex-col items-center justify-center  max-w-sm mb-5">
        ...
        <button className="w-full text-center relative h-64 bg-gray-300 bg-center bg-cover shadow-md hover:cursor-pointer" onClick={() => setModal(true)}>
        <Image alt="CarouselImage1" src={productImage}  layout="fill" objectFit="cover"/>
      <Modal
      ...
      />
            ...
            <div className="flex justify-between mt-3 item-center">
                <span className="font-bold text-gray-800 dark:text-gray-200">${data.productPrice}</span>
